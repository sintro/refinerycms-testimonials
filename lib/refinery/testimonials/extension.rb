...
#
      # def has_many_page_testimonials
        # has_many :testimonies, proc { order('position ASC') }, through: :page_testimonials, class_name: 'Refinery::Testimonial'
        # has_many :page_testimonials, proc { order('position ASC') }, as: :page, class_name: 'Refinery::PageTestimonial'
#
        # accepts_nested_attributes_for :testimonies, allow_destroy: false
#
      # end
    # end
  # end
